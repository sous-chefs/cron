...
attribute :month, :kind_of => [Integer, String], :default => "*", :callbacks => {"should be a valid month spec" => lambda { |spec| validate_nameable(spec,'mon') } }
attribute :weekday, :kind_of => [Integer, String], :default => "*", :callbacks => {"should be a valid weekday spec" => lambda { |spec| validate_nameable(spec,'dow') } }
...
def self.validate_nameable(spec,type)
  if type == "mon" then
